...
<head>
  ...
  <title>Gauganga.com | Dashboard</title>
  ...
  <div class="wrapper">
    <header class="main-header">
      <a href="<?= site_url('Welcome/Dashboard'); ?>" class="logo">
        ...
        <span class="logo-lg"><b>Gauganga.com</b></span>
      </a>
      <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown notifications-menu" title="Latest User">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <li class="dropdown tasks-menu" title="Enquiry">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            <li class="user-header">
              ...
              <p>
                <?php if(!empty($userData)){?><?php echo ucfirst($userData->name); ?><?php }else{ echo "-";} ?> - <?php if(!empty($userData)){?><?php echo ucfirst($userData->admin_type); ?><?php }else{ echo "-";} ?>
                <small></small>
              </p>
            </li>
            <li class="user-footer">
              <div class="pull-left">
                <a href="<?= site_url('Welcome/profile'); ?>" class="btn btn-default btn-flat">Profile</a>
              </div>
