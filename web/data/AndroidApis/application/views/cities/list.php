<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('Admin_dashboard/index'); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li> 
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header">
                        <div class="content-header_button  pull-right"> 
                          ...
                          <a class="btn btn-primary" title="Create" href="<?= $createAction ?>">Add City</a> 
                        </div>  
                    </div>
...
function Delete(obj,cid)
{
  ...
  { 
    ...
    $.ajax({
        type:"POST",
        url:"<?php echo site_url('Cities/delete'); ?>",
        data:datastring,
        cache:false,        
...
{ 
  ...
  if(cnf==true)
  {
    ...
    $.ajax({
        type:"POST",
        url:"<?=  site_url('Cities/change_status')?>",
        data:datastring,
        cache:false,                    
        success:function(returndata)
        {
