    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="box box-primary">
            ...
            <form method="POST" action="<?php echo $action; ?>" enctype="multipart/form-data" >
             <div class="col-md-6">
              <div class="form-group">
               <label class="control-label">Country <span style="color:red;">*</span></label> <span  style="color:red" id="errorcountry_id"> <span  style="color:red" id="errorname"><?php echo form_error('country_id')?> </span> </span> 
               <div>
                <div class="row">
                  <div class="col-md-12">
          ...
          <div class="col-md-6">
            <div class="form-group">
             <label class="control-label">State <span style="color:red;">*</span></label> <span  style="color:red" id="errorstate_id"> </span> <span  style="color:red" id="errorname"><?php echo form_error('state_id')?> </span>
             <div>
              <div class="row">
                <div class="col-md-12">
              ...
              < ?php echo form_error('country_code'); ?>
                              ...
                              <!-- <div class="col-md-6">
                                <div class="form-group"> 
                                 ...
                                 <!--  <div class="col-md-6">
                        <div class="form-group"> 
                          <label for="Image">Sort By</label> <span  style="color:red">< ?php echo form_error('sort_by')?> </span>
