...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="<?= site_url('Login/dashboard'); ?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
          ...
          <form  method="POST" action="<?= $action;?>" id="category">
            ...
            <div class="col-md-12">
              ...
              <input type="hidden" value="<?= $id ?>" name="id"/>         
                  <button type="submit" onclick="return check_error()" class="btn btn-primary pull-right"><?= $button;?></button>
