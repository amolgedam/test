                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header">
                        <div class="content-header_button  pull-right"> 
                          ...
                          <a class="btn btn-primary" title="Create" href="<?= $createAction ?>">Add Category</a> 
                        </div>  
                    </div>
...
<script>
    var url = '<?= site_url('CategoryMaster/ajax_manage_page')?>';
    var actioncolumn=4;
</script>
  ...
  function Delete(cid)
{
  ...
  { 
    ...
    $.ajax({
        type:"POST",
        url:"<?php echo site_url('CategoryMaster/delete'); ?>",
        data:datastring,
        cache:false,        
...
{ 
  ...
  if(cnf==true)
  {
    ...
    $.ajax({
        type:"POST",
        url:"<?=  site_url('CategoryMaster/change_status')?>",
        data:datastring,
        cache:false,                    
        success:function(returndata)
        {
