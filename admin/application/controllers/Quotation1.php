...
{   
    ...
    $get_product = $this->Crud_model->GetData('software_details','',"status='Active'");
    $data = array(
 ...
 public function update_quotation()
{
  ...
  public function get_customer()
    ...
    public function get_productDetails()
    {
        ...
        $get_details = $this->Crud_model->GetData('software_details','price,description',"id='".$_POST['val']."'",'','','','1');
