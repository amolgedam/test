...
<body>
	<table cellpadding="0px" cellspacing="0px" align="center" width="850px" class="main_table" id="content">
		...
		<tr>
			<td style="vertical-align: top;text-align: center;" colspan="2" height="750px">
				<table cellpadding="0px" cellspacing="0px" width="100%">
					<tr>
						<td style="padding-top: 10px;padding-bottom: 10px; vertical-align: top; text-align:left;" width="65%">
							<b style="padding-top: 3px; background-color:#0F4F91; color: white;font-size: 16px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;INVOICE NO : <?php echo $invoiceData->id; ?>&nbsp;&nbsp;</b> <br><br>
						</td>
				...
				<table cellpadding="0px" cellspacing="0px" width="95%" align="center">
					<tr>
						<td height="25px" style="border-top:1px solid #000;border-bottom:1.5px solid #000;border-left:1.5px solid #000;border-right:1px solid #fff;background-color:#0F4F91;color:white" width="5%">SR. NO</td>
						...
						<td style="border-top:1.5px solid #000;border-bottom:1.5px solid #000;background-color:#0F4F91;color:white" width="12%">CGST (%)</td>
						<td style="border-top:1.5px solid #000;border-bottom:1.5px solid #000;border-left:1.5px solid #fff;border-right:1.5px solid #fff;background-color:#0F4F91;color:white" width="12%">SGST (%)</td>
					...
					<tr>
						...
						<td style="vertical-align: top;padding-top:10px; padding-bottom:10px; text-align: right;padding-right: 10px;"><?php echo $key->cgst; ?> /-</td>
						<td style="vertical-align: top;padding-top:10px; padding-bottom:10px; text-align: right;padding-right: 10px;border-left:1.5px solid #000;border-right:1.5px solid #000;"><?php echo $key->sgst; ?> /-</td>
					...
					<?php $i++;} ?>
					<tr>
						<td height="5%" colspan="6" style="vertical-align: bottom;padding-top:10px; padding-bottom:10px; text-align: right;padding-right: 20px;font-weight: bold;border-top:1.5px solid #000;border-bottom:1.5px solid #000;border-left:1.5px solid #000;">Total</td>
		...
		<tr>
			<td height="130px" style="padding-left: 50px;padding-right: 40px;padding-top: 10px;padding-bottom: 25px;border-bottom:1px solid #000;vertical-align: top" colspan="2">
		...
		<tr>
			<td style="border-top:1px solid #000; padding-left: 50px;padding-right: 20px;padding-top: 30px;padding-bottom: 20px;" colspan="2" height="150px">
