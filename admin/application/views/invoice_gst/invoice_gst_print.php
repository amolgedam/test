...
<div>
  <table cellpadding="0px" cellspacing="0px" align="center" width="850px" style="border:1px solid #000;font-family: sans-serif;" id="content">
    ...
    <tr>
      <td style="height:650px;vertical-align: top;text-align: center;border-left:1px solid #000;" colspan="2">
        <table cellpadding="0px" cellspacing="0px" width="100%" height="120px">
          <tr>
            <td style="padding-top: 10px;vertical-align: top" width="65%">
              <b style="padding-left: 50px;padding-bottom: 3px;padding-top: 3px;background-color:#0F4F91;color: white;font-size: 16px;">INVOICE NO : <?php $var="1000"; echo $var+$invoiceData->id; ?>&nbsp;&nbsp;</b> <br><br>
              ...
              <span style="padding-left: 77px;font-size: 15px;">Mo. <?php echo $customerData->mobile_no; ?></span><br>
                  <span style="padding-left: 77px;font-size: 13px;">GSTN : <?php echo $customerData->gst_no; ?></span>
            </td>
            <td style="padding-left: 30px;padding-bottom: 3px;vertical-align: top;padding-top: 10px;">
              <table border="0" cellpadding="2px" width="100%" style="font-size: 13px;">
               <tr>
                  <td>CIN NO <b>:</b>U72900MH2019PTC332123
                </tr>
                <tr>
                  <td>GSTIN <b>:</b>&nbsp; 27AACCW5301K1ZB
                </tr>
                <tr>
                  <td>PAN &nbsp;&nbsp;&nbsp;&nbsp;<b>:</b>&nbsp; AACCW5301K
                </tr>
                 <tr>
                  <td>TAN &nbsp;&nbsp;&nbsp;&nbsp;<b>:</b>&nbsp; NGPW00816E
                </tr>
                <tr>
        ...
        <table cellpadding="0px" cellspacing="0px" width="95%" height="520px" align="center">
          <tr>
            ...
            <th height="5%"style="border-top:1.5px solid #000;border-bottom:1.5px solid #000;background-color:#0F4F91;color:white" width="12%">CGST(%)</th>
            <th height="5%"style="border-top:1.5px solid #000;border-bottom:1.5px solid #000;border-left:1.5px solid #fff;border-right:1.5px solid #fff;background-color:#0F4F91;color:white" width="12%">SGST(%)</th>
          ...
          <tr>
            ...
            <td style="vertical-align: top;padding-top:10px; padding-bottom:10px; padding-right: 10px;padding-left: 10px;text-align: justify;"><?php echo $key->product_name; ?> <br> <?php echo "[ ".$key->des." ]" ; ?></td>
            ...
            <td style="vertical-align: top;padding-top:10px; padding-bottom:10px; text-align:center;"><?php echo "( ".$key->cgst." %) ".$key->cgst_value; ?> </td>
            <td style="vertical-align: top;padding-top:10px; padding-bottom:10px; text-align:center;border-left:1.5px solid #000;border-right:1.5px solid #000;"><?php echo "( ".$key->sgst." %) ".$key->sgst_value; ?> </td>
            <td style="vertical-align: top;padding-top:10px; padding-bottom:10px; text-align:center;"><?php echo "( ".$key->discount." %)".$key->discount_value; ?></td>
            <td style="vertical-align: top;padding-top:10px; padding-bottom:10px; text-align: right;padding-right: 10px;border-left:1.5px solid #000;border-right:1.5px solid #000;"><?php echo $key->total_amount ?> /-</td>
          </tr>

              <?php $tot+= $key->total_amount; ?>


          <?php $i++;} ?>
          <tr>
            <td height="5%" colspan="6" style="vertical-align: bottom;padding-top:5px; padding-bottom:5px; text-align: right;padding-right: 20px;font-weight: bold;border-top:1.5px solid #000;border-bottom:1.5px solid #000;border-left:1.5px solid #000;">Total</td>
            <td style="vertical-align: bottom;padding-top:10px; padding-bottom:10px; text-align: right;padding-right: 10px;border-top:1.5px solid #000;border-bottom:1.5px solid #000;border-right:1.5px solid #000;border-left:1.5px solid #000;"><?php echo $tot; ?>/-</td>
          </tr>
        </table>
      </td>
    </tr>
    <tr>
      <td height="150px" style="padding-left: 50px;padding-right: 40px;padding-top: 10px;padding-bottom: 0px;border-left:1px solid #000;border-bottom:1px solid #000;vertical-align: top" colspan="2">
