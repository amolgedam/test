                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header">
                        <div class="content-header_button  pull-right"> 
                          ...
                          <a class="btn btn-primary" title="Create" href="<?= $createAction ?>">Add Service_article</a> 
                        </div>  
                    </div>
...
<script>
    var url = '<?= site_url('Service_article/ajax_manage_page')?>';
    var actioncolumn='5';
</script>
...
{ 
  ...
  if(cnf==true)
  {
    ...
    $.ajax({
        type:"POST",
        url:"<?=  site_url('Service_article/change_status')?>",
        data:datastring,
        cache:false,                    
...
function Delete(obj,id)
{
  ...
  { 
    ...
    $.ajax({
        type:"POST",
        url:"<?php echo site_url('Service_article/delete'); ?>",
        data:datastring,
        cache:false,        
        success:function(returndata)
        {
