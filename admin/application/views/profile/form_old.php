							...
							<div id="home" class="tab-pane fade in active">
								<form method="post" action="<?php echo $action ;?>" enctype="multipart/form-data">
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label>Salary<span style="color:red">*</span>
          										  <span style="color:red" id="salary_err"> </span></label>
												<input type="text" placeholder="Enter Salary" class="salary form-control" name="salary" id=""  maxlength="10" value="<?php echo $salary;?>"/>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" placeholder="Enter Ifsc" class=" ifsc form-control" name="ifsc" id="ifsc" maxlength="10" value="<?php echo $ifsc;?>" />
												</div>
											</div>
										</div>
										<button type="submit" class="btn btn-info btn-sm pull-right" onclick="return validation()" name="submit"><?php echo $button ?></button>
										<a href="<?php echo site_url('Welcome/dashboard') ?>" class="btn btn-danger btn-sm">Cancel</a>
									</form> 
								</div>
												...
												<div  class="col-md-12"  id="user1" style="display:none;">
													<div class="col-md-4">
														<div class="form-group">
															...
															<?php if(!empty($doc->final)) { ?>
															<img src="<?php echo base_url('uploads/document/'.$doc->final);?>" style="height:100px;width:100px;">
														<?php } ?>
														<input type="hidden" name="final_old" value="<?php echo $doc->final;?>">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<img src="<?php echo base_url('uploads/document/'.$doc->degree);?>" style="height:100px;width:100px;">
														<?php } ?>
														<input type="hidden" name="degree_old" value="<?php echo $doc->degree;?>">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<img src="<?php echo base_url('uploads/document/'.$doc->final);?>" style="height:100px;width:100px;">
														<?php } ?>
														<input type="hidden" name="adhar_old" value="<?php echo $doc->degree;?>">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="file" class="pan form-control" name="pan" placeholder="" id="pan"  value="< ?php echo $pan;?>"  />
															<?php if(!empty($doc->pan)) { ?>
															<img src="<?php echo base_url('uploads/document/'.$doc->pan);?>" style="height:100px;width:100px;">
														<?php } ?>

															<input type="hidden" name="pan_old" value="<?php echo $doc->pan;?>">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="file" class="experience_cer form-control" name="experience_cer" placeholder="" id="experience"  value="< ?php echo $experience_cer;?>"/>
																<?php if(!empty($doc->experience_cer)) { ?>
															<img src="<?php echo base_url('uploads/document/'.$doc->experience_cer);?>" style="height:100px;width:100px;">
														<?php } ?>

															<input type="hidden" name="experience_cer_old" value="<?php echo $doc->experience_cer ;?>">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="file" class="relieving_cer form-control" name="relieving_cer" placeholder="" id="relieving_cer"  value="< ?php echo $relieving_cer;?>"/>
																<?php if(!empty($doc->relieving_cer)) { ?>
															<img src="<?php echo base_url('uploads/document/'.$doc->relieving_cer);?>" style="height:100px;width:100px;">
														<?php } ?>

															<input type="hidden" name="relieving_cer_old" value="<?php echo $doc->relieving_cer ;?>">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="file" class="payment_slip form-control" name="payment_slip" placeholder="" id="payment_slip"  value="< ?php echo $payment_slip;?>"  />
																<?php if(!empty($doc->payment_slip)) { ?>
															<img src="<?php echo base_url('uploads/document/'.$doc->payment_slip);?>" style="height:100px;width:100px;">
														<?php } ?>

															<input type="hidden" name="payment_slip_old" value="<?php echo $doc->payment_slip;?>">
														</div>
													</div>
												</div>
												<div  class="col-md-12"  id="user2" style="display:none;">
													<div class="col-md-4">
														<div class="form-group">
															...
															<?php if(!empty($doc->final_marksheet)) { ?>
															<img src="<?php echo base_url('uploads/document/'.$doc->final_marksheet);?>" style="height:100px;width:100px;">
														<?php } ?>

															<input type="hidden" name="final_marksheet_old" value="<?php echo $doc->final_marksheet;?>">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<?php if(!empty($doc->final_degree)) { ?>
															<img src="<?php echo base_url('uploads/document/'.$doc->final_degree);?>" style="height:100px;width:100px;">
														<?php } ?>

															<input type="hidden" name="final_degree_old" value="<?php echo $doc->final_degree;?>">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<?php if(!empty($doc->final_adhar)) { ?>
															<img src="<?php echo base_url('uploads/document/'.$doc->final_adhar);?>" style="height:100px;width:100px;">
														<?php } ?>

															<input type="hidden" name="final_adhar_old" value="<?php echo $doc->final_adhar;?>">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<?php if(!empty($doc->final_pan)) { ?>
															<img src="<?php echo base_url('uploads/document/'.$doc->final_pan);?>" style="height:100px;width:100px;">
														<?php } ?>

															<input type="hidden" name="final_pan_old" value="<?php echo $doc->final_pan;?>">
                ...
                function validation()
				{
                  ...
                  if(birthday=="")
                         ...
                         if(address=="")
                       {
                         ...
                         if(salary=="")
                       {
                         $("#salary_err").fadeIn().html("Please enter salary").css('color','red');
                             setTimeout(function(){   
                               $("#salary_err").html("&nbsp;");},3000);
                             $(".salary").focus();
                            return false;
                        }
