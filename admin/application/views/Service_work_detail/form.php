    ...
    <section class="content-header">
      ...
      <div>&nbsp;<?php echo $headinggg; ?></div>
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo site_url('Service_work_detail/index'); ?>">Manage Service work detail List</a></li>
            <li class="active">
                <?= $headinggg;?>
            </li>
        </ol>
                    ...
                    <div class="box-body">
                        <form method="POST" action="<?php echo $action; ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group"> 
                                        ...
                                        <input type="file" name="image" id="image"  class="inputfile form-control"/> <br/>  
                                        <?php if($image!=''){ ?>
                                          <img src="<?php echo base_url() ?>uploads/service/<?php echo $image; ?>" height="100px" width="100px">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">Service List Description <span style="color:red;">*</span></label>
                          ...
                          <div class="box-footer">
                           ...
                           <a href="<?= site_url('Service_work_detail');?>"><button type="button"  class="btn btn-danger pull-right">Cancel</button></a>
