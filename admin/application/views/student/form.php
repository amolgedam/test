              ...
              <form method="POST" action="<?php echo $action; ?>"  enctype="multipart/form-data" >
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <input type="text" placeholder="Enter Date" class="form-control" id="apdate" name="aptdate" value="<?php echo $aptdate; ?>">
                  </div>
                </div>
                ...
                <div class="col-sm-1">
                 ...
                 <div class="col-md-2">
                                        ...
                                        <input type="text" placeholder="Enter appointment time" class="form-control" id="apttime" name="apttime" value="<?php echo $apttime; ?>">
                                        </div>
                                    </div>
