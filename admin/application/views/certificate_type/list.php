                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header">
                        <div class="content-header_button  pull-right"> 
                          ...
                          <a class="btn btn-primary" title="Create" href="<?= $createAction ?>">Add Certificate Type</a> 
                        </div>  
                    </div>
...
<script>
    var url = '<?= site_url('Certificate_type/ajax_manage_page')?>';
    var actioncolumn='3';
</script>
...
{ 
  ...
  if(cnf==true)
  {
    ...
    $.ajax({
        type:"POST",
        url:"<?=  site_url('Certificate_type/change_status')?>",
        data:datastring,
        cache:false,                    
...
function Delete(obj,cid)
{
  ...
  { 
    ...
    $.ajax({
        type:"POST",
        url:"<?php echo site_url('Certificate_type/delete'); ?>",
        data:datastring,
        cache:false,        
        success:function(returndata)
        {
