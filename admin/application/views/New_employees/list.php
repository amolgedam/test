                ...
                <div class="box box-primary"> 
                    ...
                    <!-- <div class="box-header">
                        <div class="content-header_button  pull-right"> 
                          ...
                          <a class="btn btn-primary" title="Create" href="<?= $createAction ?>">New Employees</a> 
                        </div>  
                    </div> -->
...
<script>
    var url = '<?= site_url('New_employee/ajax_manage_page')?>';
    var actioncolumn=6;
</script>
...
function Delete(obj,id)
{
  ...
  { 
    ...
    $.ajax({
        type:"POST",
        url:"<?php echo site_url('New_employee/delete'); ?>",
        data:datastring,
        cache:false,        
...
{ 
  ...
  if(cnf==true)
  {
    ...
    $.ajax({
        type:"POST",
        url:"<?=  site_url('New_employee/change_status')?>",
        data:datastring,
        cache:false,                    
        success:function(returndata)
        {
