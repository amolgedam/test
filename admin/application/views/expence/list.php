                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header">
                        <div class="content-header_button  pull-right"> 
                          ...
                          <a class="btn btn-primary" title="Create" href="<?= $createAction ?>">Add Expence</a> 
                        </div>  
                    </div>
...
<script>
    var url = '<?= site_url('Expence/ajax_manage_page')?>';
    var actioncolumn='4';
</script>
...
{ 
  ...
  if(cnf==true)
  {
    ...
    if(status=="Pending")
    {
      $("#statusVal"+id).removeClass("btn-warning");
    ...
    else
    {
      ...
      $("#statusVal"+id).addClass("btn-warning");
    ...
    $.ajax({
        type:"POST",
        url:"<?=  site_url('Expence/change_status')?>",
        data:datastring,
        cache:false,                    
...
function Delete(obj,cid)
{
  ...
  { 
    ...
    $.ajax({
        type:"POST",
        url:"<?php echo site_url('Expence/delete'); ?>",
        data:datastring,
        cache:false,        
        success:function(returndata)
        {
