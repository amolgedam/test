                        ...
                        <form method="POST" action="<?php echo $action; ?>" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="type" name="type" onclick="get_type(this.value)">
                                        <option value="">Select Industrial Type</option>
                                        <option value="Product_Engineering"<?php if ($industry_type == 'Product_Engineering') echo ' selected="selected"'; ?>>Product Engineering</option>
                                        <option value="Markets"<?php if ($industry_type == 'Markets') echo ' selected="selected"'; ?>>Markets</option>
                                        <option value="Investment"<?php if ($industry_type == 'Investment') echo ' selected="selected"'; ?>>Investment</option>
                                        <option value="Financial"<?php if ($industry_type == 'Financial') echo ' selected="selected"'; ?>>Financial</option>
                                    </select>
                                </div>
                            </div>
                           ...
                           <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="title" name="title">
                                        ...
                                        <option value="<?php echo $title; ?>" <?php if($titleDataid==$title) { echo "selected"; }?> ><?php echo $titleData; ?> </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if(!empty($image)) {?>
                                     ...
                                     <?php foreach ($image as $row) { ?>
                                      <div class="col-md-3">
                                          <p><img src="<?php echo base_url()?>uploads/industries/<?php echo $row->image;?>" width="230px" height="200px" style="margin-top: 20px;">&nbsp;<center>
                          ...
                          <div class="box-footer">
                           ...
                           <a href="<?= site_url('Industries_Detail');?>"><button type="button"  class="btn btn-danger pull-right">Cancel</button></a>
