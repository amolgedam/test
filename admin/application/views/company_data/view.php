...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       ...
       <li class="active">Compnay Data View</li>
      </ol>
    </section>
    <section class="content">
        <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="panel-heading"><h4>View<a href="<?= site_url('Manage_company_data');?>"><button type="button"  class="btn btn-primary pull-right">Back</button></a></h4></div>
              <div class="panel-body">
                <div class="col-md-4">
                    <div class="form-group">
                      <label>CIN :</label>
                      <p><?php if(!empty($cin)) { echo $cin;}else {echo "N/A";}?></p>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="form-group">
                      ...
                      <p><?php if(!empty($company_data)) { echo $company_data;}else {echo "N/A";}?></p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <p><?php if(!empty($date_reg)) { echo $date_reg;}else {echo "N/A";}?></p>
                    </div>
                </div>
               <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <p><?php if(!empty($active_description)) { echo $active_description;}else {echo "N/A";}?></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
