list.php<div class="content-wrapper">
...
<div class="modal inmodal" id="uploadData" data-modal-color="lightblue" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content animated bounceInRight">   
            <form method="post" action="<?= site_url('Manage_company_data/import_excel')?>" method="post" enctype="multipart/form-data" onsubmit="return checkXcel()">  
                <div class="modal-header">
                    <span style="font-size:20px">Upload Sheet</span>
                </div>     
                <div class="modal-body" style="padding-top: 3%">

                    <a download class="pull-right" href="<?php echo base_url('uploads/company_data/data.xlsx'); ?>" style="font-size:10px">Download Sample Format</a> 
      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
          <form id="frm_add" method="POST">
            <input type="hidden" class="form-control" name="company_data_id" id="company_data_id">
...
<!--mail-->
  ...
  <!--End Mail-->
<script>
    var url = '<?= site_url('Manage_company_data/ajax_manage_page/'.$flag)?>';
    var actioncolumn=10;
</script>

<script> setTimeout(function(){ $(".errid").fadeOut(); },3000); </script>

<script src="<?= base_url(); ?>assets/custom_js/import_excel.js"></script>
