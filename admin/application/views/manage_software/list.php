                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header">
                        <div class="content-header_button  pull-right"> 
                          ...
                          <a class="btn btn-primary" title="Create" href="<?= $createAction ?>">Add Software Details </a> 
                        </div>  
                    </div>  
                <div class="box-body">
...
<script>
    var url = '<?= site_url('Manage_Software/ajax_manage_page')?>';
    var actioncolumn=3;
</script>
...
function Delete(obj,id)
{
  ...
  { 
    ...
    $.ajax({
        type:"POST",
        url:"<?php echo site_url('Manage_Software/delete'); ?>",
        data:datastring,
        cache:false,        
...
{ 
  ...
  if(cnf==true)
  {
    ...
    $.ajax({
        type:"POST",
        url:"<?=  site_url('Manage_Software/change_status')?>",
        data:datastring,
        cache:false,                    
        success:function(returndata)
        {
