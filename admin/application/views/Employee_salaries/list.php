                ...
                <div class="box box-primary"> 
                    ...
                    <div class="box-header">
                        <div class="content-header_button  pull-right"> 
                          ...
                          <a class="btn btn-primary" title="Create" href="<?= $createAction ?>">Add Employee Salary</a> 
                        </div>  
                    </div>
...
<script>
    var url = '<?= site_url('Employee_salaries/ajax_manage_page')?>';
    var actioncolumn=9;
</script>
...
function Delete(obj,id)
{
  ...
  { 
    ...
    $.ajax({
        type:"POST",
        url:"<?php echo site_url('Employee_salaries/delete'); ?>",
        data:datastring,
        cache:false,        
...
{ 
  ...
  if(cnf==true)
  {
    ...
    $.ajax({
        type:"POST",
        url:"<?=  site_url('Employee_salaries/change_status')?>",
        data:datastring,
        cache:false,                    
        success:function(returndata)
        {
