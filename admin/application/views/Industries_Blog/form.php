                        ...
                        <form method="POST" action="<?php echo $action; ?>" enctype="multipart/form-data">
                             <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">Services Headingnb <span style="color:red;">*</span></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">Service Description <span style="color:red;">*</span></label>
                          ...
                          <div class="box-footer">
                           ...
                           <a href="<?= site_url('Industries_Blog');?>"><button type="button"  class="btn btn-danger pull-right">Cancel</button></a>
