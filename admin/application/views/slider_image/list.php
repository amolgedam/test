                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header">
                        <div class="content-header_button  pull-right"> 
                          <a class="btn btn-primary" title="Create" href="<?= $createAction ?>">Add Image</a> 
                        </div>  
                    </div>
...
<div class="modal fade" id="deleteData" data-modal-color="lightblue" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <form method="post" action="<?= $deleteAction ?>">       
                <div class="modal-body" style="height: 120px;padding-top: 3%">
                    <center>
                        ...
                        <span style="font-size: 16px">Are you sure want to delete this product ?</span>
                    </center>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary">Ok</button>
 ...
 <script>
    var url = '<?= site_url('Slider_image/ajax_manage_page')?>';
    var actioncolumn=4;
</script>
...
{ 
  ...
  if(cnf==true)
  {
    ...
    $.ajax({
        type:"POST",
        url:"<?=  site_url('Slider_image/change_status')?>",
        data:datastring,
        cache:false,                    
   ...
   function Delete(obj,cid)
{
  ...
  { 
    ...
    $.ajax({
        type:"POST",
        url:"<?php echo site_url('Slider_image/delete'); ?>",
        data:datastring,
        cache:false,        
        success:function(returndata)
        {
