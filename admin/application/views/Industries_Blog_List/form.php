                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form method="POST" action="<?php echo $action; ?>" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">Blog List Heading <span style="color:red;">*</span></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">Blog List Description <span style="color:red;">*</span></label>
                          ...
                          <div class="box-footer">
                           ...
                           <a href="<?= site_url('Industrial_Blog_list');?>"><button type="button"  class="btn btn-danger pull-right">Cancel</button></a>
