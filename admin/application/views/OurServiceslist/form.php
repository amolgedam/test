    ...
    <section class="content-header">
      ...
      <div>&nbsp;<?php echo $headinggg; ?></div>
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo site_url('OurServiceslist/index'); ?>">Manage Service List</a></li>
            <li class="active">
                <?= $headinggg;?>
            </li>
        </ol>
                    ...
                    <div class="box-body">
                        <form method="POST" action="<?php echo $action; ?>" enctype="multipart/form-data">
                          ...
                          <div class="box-footer">
                           ...
                           <a href="<?= site_url('OurServiceslist');?>"><button type="button"  class="btn btn-danger pull-right">Cancel</button></a>
