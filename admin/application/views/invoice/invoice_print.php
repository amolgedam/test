...
<div>
	<table cellpadding="0px" cellspacing="0px" align="center" width="850px" style="border:1px solid #000;font-family: sans-serif;" id="content">
		...
		<tr>
			<td style="height:650px;vertical-align: top;text-align: center;border-left:1px solid #000;" colspan="2">
				<table cellpadding="0px" cellspacing="0px" width="100%" height="120px">
					<tr>
						<td style="padding-top: 10px;vertical-align: top" width="65%">
							<b style="padding-left: 50px;padding-bottom: 3px;padding-top: 3px;background-color:#0F4F91;color: white;font-size: 16px;">INVOICE NO : <?php echo $invoiceData->id; ?>&nbsp;&nbsp;</b> <br><br>
				...
				<table cellpadding="0px" cellspacing="0px" width="95%" height="520px" align="center">
					<tr>
						<th height="5%" style="border-top:1px solid #000;border-bottom:1.5px solid #000;border-left:1.5px solid #000;border-right:1px solid #fff;background-color:#0F4F91;color:white" width="9%">SR. NO</th>
					...
					<tr>
						...
						<td style="vertical-align: top;padding-top:10px; padding-bottom:10px; padding-right: 10px;padding-left: 10px;text-align: justify;"><?php echo $key->product_name; ?> </td>
					...
					<?php $i++;} ?>
					<tr>
						<td height="5%" colspan="4" style="vertical-align: bottom;padding-top:5px; padding-bottom:5px; text-align: right;padding-right: 20px;font-weight: bold;border-top:1.5px solid #000;border-bottom:1.5px solid #000;border-left:1.5px solid #000;">Total</td>
						<td style="vertical-align: bottom;padding-top:5px; padding-bottom:5px; text-align: right;padding-right: 10px;border-top:1.5px solid #000;border-bottom:1.5px solid #000;border-right:1.5px solid #000;border-left:1.5px solid #000;"><?php echo $invoiceData->total_amount; ?>/-</td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td style="border-top:1px solid #000; padding-left: 0px;padding-right: 20px;padding-top: 20px;padding-bottom: 10px;border-left:1px solid #000;border-bottom:1px solid #000;" colspan="2">
