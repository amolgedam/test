		...
		<tr>
			<td style="vertical-align: top;text-align: center;" colspan="2" height="750px">
				<table cellpadding="0px" cellspacing="0px" width="100%">
					<tr>
						<td style="padding-top: 10px;padding-bottom: 10px; vertical-align: top; text-align:left;" width="65%">
							<b style="padding-top: 3px; background-color:#0F4F91; color: white;font-size: 16px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;QUOTATION NO : <?php echo $invoiceData->id; ?>&nbsp;&nbsp;</b> <br><br>
						</td>
				...
				<table cellpadding="0px" cellspacing="0px" width="95%" align="center">
					...
					<?php $i++;} ?>
					<tr>
						<td height="5%" colspan="4" style="vertical-align: bottom;padding-top:10px; padding-bottom:10px; text-align: right;padding-right: 20px;font-weight: bold;border-top:1.5px solid #000;border-bottom:1.5px solid #000;border-left:1.5px solid #000;">Total</td>
