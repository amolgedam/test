                ...
                <table class="table table-bordered" id="purchaseTableclone123" >
                  <thead>
                    <tr bgcolor="#e0e0d1">
                      ...
                      <th class="col-xs-2"><h5><b>Price </b><span style="color:red;">*</span><span style="color:red;font-size:12px" id="error3" class="error"></span> </h5></th>
...
?>
<script type="text/javascript" src="<?= base_url()?>assets/custom_js/attributes.js"></script>
  ...
  function getcustomer(id)
{
  var id = id;
        $.ajax({
                type:"post",
                cache:false,
                url:"<?php echo site_url('/Invoice/get_customer');?>",
                data:{id:id},
