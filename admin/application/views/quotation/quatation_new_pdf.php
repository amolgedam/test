...
<body>
	<table cellspacing="0px" cellpadding="5px" align="center" width="850px" style="border:1px solid #000;" >
		...
		<tr>
			<td style="border-bottom:1px;"><b>GST No. <?php echo $settings->gst_no;?></b></td>
			<td style="border-bottom:1px;"><b style="float:right;">Pan No. <?php echo $settings->pan_no;?></b></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<tr>
				<td style="text-align:left border:none;border-bottom:0px;">
				...
				<td style="text-align:right;padding:0px;margin:0px;border-bottom:0px;">
					...
					<td colspan="2" style="border-bottom:0px;">
						<table cellspacing="0px" cellpadding="5px" align="center" width="100%" border="1">
							...
							<?php if(!empty($logData)) { $sr=1; foreach($logData as $log)
								{ 
								 $get_software = $this->Crud_model->GetData('software',"title","id='".$log->product_name."'",'','','','1');

								 $exlopd = explode(",", $log->description);
				...
				<tr>
					<td colspan="2" style="width:600px;padding:0px;margin:0px;border:0px;border-bottom:0px;">
					<span style="margin-right:20px;"><b>Terms and Conditions:</b></span> 
					</td>
				</tr>
				<tr>
					<td colspan="2" style="border-bottom:0px;border-top:0px;">
						<p style="text-align:justify;"><?php echo strip_tags($invoiceData->terms);?></p>
					</td>
				</tr>
				<tr>
