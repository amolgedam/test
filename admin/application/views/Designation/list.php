                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header">
                        <div class="content-header_button  pull-right"> 
                          ...
                          <a class="btn btn-primary" title="Create" href="<?= $createAction ?>">Add Designation</a> 
                        </div>  
                    </div>
...
<script>
    var url = '<?= site_url('Designation/ajax_manage_page')?>';
    var actioncolumn='3';
</script>
...
{ 
  ...
  if(cnf==true)
  {
    ...
    $.ajax({
        type:"POST",
        url:"<?=  site_url('Designation/change_status')?>",
        data:datastring,
        cache:false,                    
