      ...
      ?> -->
                                <div class="form-group">
                                    ...
                                    <option value="<?php echo $row->id?>" 
                                        <?php if($service_id==$row->id) { echo "selected";}?>><?php echo $row->heading;?></option>
                                     <?php }}?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Enter Heading" class="form-control" id="service_heading" name="service_heading" value="<?php echo $service_heading; ?>">
                                </div>
                            </div>
