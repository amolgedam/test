            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="control-label"> Blog Heading Title <span style="color:red;">* </span></label>
                                    <span style="color:red" id="title_err"> </span>
                                    <select class="form-control" id="blog_heading_id" name="blog_heading_id">
                                        <option value="">Select Blog Heading</option>
                                        <?php if(!empty($product_blog)) { foreach($product_blog as $row) { ?>
                        <option value="<?php echo $row->id;?>"<?php if($blog_heading_id==$row->id) { echo "selected";}?>><?php echo $row->blog_heading; ?></option>
                                     <?php }}?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Blog Heading List <span style="color:red;">*</span></label>
                                    <span style="color:red" id="heading_err"> </span>
                                    <input type="text" placeholder="Enter Service Heading List" class="form-control" id="blog_heading_list" name="blog_heading_list" value="<?php echo $blog_heading_list; ?>">
                                </div>
                            </div>
