       ...
       <td> <img src="<?php echo base_url('uploads/logo/logo1.jpg') ?>" width="300px" height="200px" alt="" /></td>
        <td style="padding:0px;margin:0px;">
          <table style=" padding:0px; margin:0px; margin-left:400px;" width="608px;" cellspacing="10px">
            ...
            <tr>
              <td>
                <span style=" margin-left:400px; font-size:20px; color:blue;"> Website: -<?php if(!empty($website)){ echo $website;}?></span>
              </td>
            </tr> 
        ...
        <tr>
          <td colspan="2" >
            <center><h1><b>TO WHOMSOEVER IT MAY CONCERN</b></h1></center> 
          </td>
        </tr>
        <br>
         <tr>
            <td colspan="2" style="text-align:justify; line-height:2.5;">
               <span style="margin-left:0px; font-size:25px; text-align:justify; line-height:2.5"><?php if(!empty($description)){ echo $description;}?>
               </span>
            </td>
        </tr>
       <br> 
