...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       ...
       <li class="active">Hardware View</li>
      </ol>
    </section>
    <section class="content">
        <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="panel-heading"><h4>View<a href="<?= site_url('Hardware_Service');?>"><button type="button"  class="btn btn-primary pull-right">Back</button></a></h4></div>
