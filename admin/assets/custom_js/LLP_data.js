    ...
    function Delete(obj,cid)
{
 ...
 var site_url=$("#site_url").val();
  ...
  { 
    ...
    $.ajax({
        type:"POST",
         url:site_url+"/LLP_company_data/delete",
        data:datastring,
        cache:false,        
...
function follow_date(id)
 {  
      var site_url = $("#site_url").val();
        ...
        type:'post',
        cache:false,
        url:site_url+'/LLP_company_data/follow_id_insert',
        data:{
          id:id,
        },
        success:function(returndata)
...
function create_follow_date()
 {
     ...
     var flag = $("#flag").val();
      ...
      $.ajax({
        type:'post',
        cache:false,
        url:site_url+'/LLP_company_data/follow_date_insert',
        data:{
        ...
        success:function(returndata)
        {
          ...
          if(flag=='')
            {
              window.location.href=site_url+"/LLP_company_data";
            }
            else
            {
             window.location.href=site_url+"/LLP_company_data/index/"+flag; 
 ...
 function assign_data()
 {
   ...
   $.ajax({
      url:site_url+'/LLP_company_data/assign_data',
     type: 'POST',
   ...
   var flag = $("#flag").val();
     ...
     // var order_no=$("#order_no").val().trim();
      ...
      $.ajax({
        type:'post',
        cache:false,
        url:site_url+'/LLP_company_data/order',
